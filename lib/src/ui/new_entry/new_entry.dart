...
import 'package:pic2alert/src/common/convert_time.dart';
import 'package:pic2alert/src/global_bloc.dart';
import 'package:pic2alert/src/models/errors.dart';
import 'package:pic2alert/src/models/medicine.dart';
import 'package:pic2alert/src/models/medicine_type.dart';
import 'package:pic2alert/src/ui/homepage/homepage.dart';
import 'package:pic2alert/src/ui/new_entry/new_entry_bloc.dart';
import 'package:pic2alert/src/ui/success_screen/success_screen.dart';
        ...
        child: Provider<NewEntryBloc>.value(
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              Padding(
                padding: EdgeInsets.symmetric(horizontal: 04.00),
  ...
  Future<void> scheduleNotification(Medicine medicine) async {
    ...
    for (int i = 0; i < (24 / medicine.interval).floor(); i++) {
      ...
      await flutterLocalNotificationsPlugin.showDailyAtTime(
          ...
          'Pic2Alert: ${medicine.medicineName}',
